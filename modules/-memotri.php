...
<div id="pagewrap">
	...
	<div id="soleil1"><img src="img/soleil_1.png" width="71"></div>
	<div id="soleil2"><img src="img/soleil_2.png" width="71"></div>
	<div id="soleil3"><img src="img/soleil_3.png" width="71"></div>
		<div id="texte1"><h3>Votre bac jaune est collecté <?php echo $jour_cs; ?></h3></div>
		...
		<div id="txtsacjaune"><h4 style="color:black">Les sacs jaunes sont disponibles en Mairie de Pau.</h4></div>
		<div id="envrac"><img src="img/envrac.png" width="203"></div>

<?php
 ...
 /***** Dernière modification : 08/07/2016, Romain TALDU	*****/
  ...
  // Adresse du site
 // define('URL_SITE', 'https://compostage.agglo-pau.fr');
  //define('URL_SITE', 'http://http://localhost:8888/formulaire-drh');
  
  //balise <title>
 // define("TITLE", "Réunion de sensibilisation au compostage");
